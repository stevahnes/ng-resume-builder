export const SAMPLE_RESUME_JSON: string = JSON.stringify({
  header: {
  ...
  work: [
    {
      ...
      descriptions: [
        'Developed key features for three modules within our SaaS-based Airport Management Suite using frameworks. I am making this bullet point longer to test the split text to size logic and make sure it works well.',
  ...
  awardsAndCertifications: [
    ...
    {
      name: 'Tay Chen Hui Memorial Award',
      acquiredDate: 'July 2013'
    },
    {
      name: 'ASEAN Undergraduate Scholarship',
      acquiredDate: 'May 2013'
    },
    {
    ...
    {
      name:
        'Some very very long award name to test the split text to size and make sure that it does not overlap the date of acquisition.',
      acquiredDate: 'September 2888'
    }
  ]
});
